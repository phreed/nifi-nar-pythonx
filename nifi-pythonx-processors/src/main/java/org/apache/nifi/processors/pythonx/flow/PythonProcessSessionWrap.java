 ...
 */
package org.apache.nifi.processors.pythonx.flow;
...
/**
 * Wrapped session that produces python wrapped session-file.
 */
@SuppressWarnings("unused")
public class PythonProcessSessionWrap extends ProcessSessionWrap {

    public PythonProcessSessionWrap(ProcessSession s, boolean toFailureOnError) {
    ...
    public SessionFile wrap(FlowFile f) {
        ...
        return new PythonSessionFile(this, f);
    }
    ...
    public List<FlowFile> get(Closure filter) {
        return this.get(new FlowFileFilter() {
            ...
            public FlowFileFilterResult filter(FlowFile flowFile) {
                ...
                return (org.codehaus.python.runtime.DefaultPythonMethods.asBoolean(res) ? FlowFileFilterResult.ACCEPT_AND_CONTINUE : FlowFileFilterResult.REJECT_AND_CONTINUE);
            }
        });
    }
}